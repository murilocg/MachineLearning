...
public class LogistRegressionRegularizationExample {
	...
	public static void main(String[] args) {
		...
		theta = GradientDescent.compute(new ConfigGradientDescent(X, Y, theta, hypothesis, 0.1, 1, 2000));
		...
		System.out.println(MessageFormat.format(msg, p.get(1), p.get(2), Math.round(hypothesis.compute(p, theta).get(0)) == 1 ? "approved" : "disapproved"));
	}
}